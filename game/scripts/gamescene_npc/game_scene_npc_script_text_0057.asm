...
SECTION "Text0057 Bank 69 Segment 0", ROMX[$61A9], BANK[$69]
...
SECTION "Text0057 Bank 69 Segment 1", ROMX[$7B70], BANK[$69]
...
SECTION "Text0057 Bank 6A Segment 0", ROMX[$54F3], BANK[$6A]
...
SECTION "Text0057 Bank 6A Segment 1", ROMX[$6D38], BANK[$6A]
...
SECTION "Text0057 Bank 6B Segment 0", ROMX[$4F50], BANK[$6B]
...
SECTION "Text0057 Bank 6B Segment 1", ROMX[$6926], BANK[$6B]
