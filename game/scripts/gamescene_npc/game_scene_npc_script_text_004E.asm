...
SECTION "Text004E Bank 69 Segment 0", ROMX[$54C1], BANK[$69]
...
SECTION "Text004E Bank 69 Segment 1", ROMX[$6E9E], BANK[$69]
...
SECTION "Text004E Bank 6A Segment 0", ROMX[$47E1], BANK[$6A]
...
SECTION "Text004E Bank 6A Segment 1", ROMX[$6041], BANK[$6A]
...
SECTION "Text004E Bank 6B Segment 0", ROMX[$41E4], BANK[$6B]
...
SECTION "Text004E Bank 6B Segment 1", ROMX[$5B0E], BANK[$6B]
