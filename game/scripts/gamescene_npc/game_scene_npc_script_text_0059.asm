...
SECTION "Text0059 Bank 6B Segment 0", ROMX[$6FD0], BANK[$6B]
...
SECTION "Text0059 Bank 6B Segment 1", ROMX[$7057], BANK[$6B]
...
SECTION "Text0059 Bank 6B Segment 2", ROMX[$7150], BANK[$6B]
