...
SECTION "Text0060 Bank 6B Segment 0", ROMX[$7A4F], BANK[$6B]
...
SECTION "Text0060 Bank 6B Segment 1", ROMX[$7AEE], BANK[$6B]
...
SECTION "Text0060 Bank 6B Segment 2", ROMX[$7CB7], BANK[$6B]
