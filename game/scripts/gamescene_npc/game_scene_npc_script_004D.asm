...
GameSceneNPCScript004DReference01::
  ...
  db $07, $00
  db $00 ; WriteText
    dwb GameSceneNPCScript004DReference0A, BANK(GameSceneNPCScript004DReference0A)
  db $18 ; Option Select
    dwb GameSceneNPCScript004DReference0B, BANK(GameSceneNPCScript004DReference0B) ; Text
    dw GameSceneNPCScript004DReference0C ; Option Branch
    dwb GameSceneNPCScript004DReference0D, BANK(GameSceneNPCScript004DReference0D) ; Text
    dw GameSceneNPCScript004DReference0E ; Option Branch
    dw $FFFF
...
SECTION "Game Scene NPC Script 004D Reference 09 (Data)", ROMX[$4B7C], BANK[$69]
GameSceneNPCScript004DReference09::
  db $C0,$74,$74,$74,$DB,$DB,$DE,$00 ; Text

SECTION "Game Scene NPC Script 004D Reference 0A (Data)", ROMX[$4B84], BANK[$69]
...
SECTION "Game Scene NPC Script 004D Reference 0B (Data)", ROMX[$4B9F], BANK[$69]
GameSceneNPCScript004DReference0B::
  db $42,$4D,$4C,$20,$28,$48,$00 ; Text

SECTION "Game Scene NPC Script 004D Reference 0C (Subroutine)", ROMX[$4E31], BANK[$51]
GameSceneNPCScript004DReference0C::
  db $07, $00
  db $00 ; WriteText
    dwb GameSceneNPCScript004DReference12, BANK(GameSceneNPCScript004DReference12)

SECTION "Game Scene NPC Script 004D Reference 0D (Data)", ROMX[$4BA6], BANK[$69]
GameSceneNPCScript004DReference0D::
  db $42,$4D,$4C,$20,$28,$34,$21,$00 ; Text

SECTION "Game Scene NPC Script 004D Reference 0E (Subroutine)", ROMX[$4E2A], BANK[$51]
...
SECTION "Game Scene NPC Script 004D Reference 10 (Data)", ROMX[$4A00], BANK[$69]
GameSceneNPCScript004DReference10::
  db $45,$2B,$6D,$20,$28,$48,$57,$DE,$00 ; Text

SECTION "Game Scene NPC Script 004D Reference 11 (Data)", ROMX[$49DF], BANK[$69]
...
SECTION "Game Scene NPC Script 004D Reference 12 (Data)", ROMX[$4BCE], BANK[$69]
GameSceneNPCScript004DReference12::
  db $45,$2B,$6D,$20,$28,$48,$4B,$45,$DE,$00 ; Text

SECTION "Game Scene NPC Script 004D Reference 13 (Data)", ROMX[$4BAE], BANK[$69]
