...
GameSceneNPCScriptReference219C::
  ...
  db $07 ; Portrait
    db $88
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21A0, BANK(GameSceneNPCScriptReference21A0)
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21A1, BANK(GameSceneNPCScriptReference21A1)
  db $07 ; Portrait
    db $04
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21A2, BANK(GameSceneNPCScriptReference21A2)
  db $07 ; Portrait
    db $88
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21A3, BANK(GameSceneNPCScriptReference21A3)
  db $07 ; Portrait
    db $04
  db $00 ; WriteText
  ...
  db $07 ; Portrait
    db $00
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21B2, BANK(GameSceneNPCScriptReference21B2)
  db $0B
    db $00
    db $FF
    db $D1
  ...
  db $0B
    ...
    db $B9
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21B3, BANK(GameSceneNPCScriptReference21B3)
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21B4, BANK(GameSceneNPCScriptReference21B4)
  db $0B
    db $00
    db $FF
    db $7A
...
GameSceneNPCScriptReference219D::
  db $26
    dwb GameSceneNPCScriptReference21B5, BANK(GameSceneNPCScriptReference21B5) ; If Male
    dwb GameSceneNPCScriptReference21B6, BANK(GameSceneNPCScriptReference21B6) ; If Female

SECTION "Game Scene NPC Script 0058 Reference 219E (Subroutine)", ROMX[$4B40], BANK[$50]
GameSceneNPCScriptReference219E::
  db $26
    dwb GameSceneNPCScriptReference21B7, BANK(GameSceneNPCScriptReference21B7) ; If Male
    dwb GameSceneNPCScriptReference21B8, BANK(GameSceneNPCScriptReference21B8) ; If Female
...
GameSceneNPCScriptReference219F::
  ...
  db $07 ; Portrait
    db $88
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21B9, BANK(GameSceneNPCScriptReference21B9)
  db $00 ; WriteText
...
SECTION "Game Scene NPC Script 0058 Reference 21A6 (Data)", ROMX[$6A23], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21A9 (Data)", ROMX[$6A8C], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21AC (Data)", ROMX[$6AF0], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21B2 (Data)", ROMX[$6BB2], BANK[$6B]
GameSceneNPCScriptReference21B2::
  db "やりましたね　さくらさん。",$00

SECTION "Game Scene NPC Script 0058 Reference 21B3 (Data)", ROMX[$6BC0], BANK[$6B]
GameSceneNPCScriptReference21B3::
  db "バッチリですね<BR><NAME>さん。",$00

SECTION "Game Scene NPC Script 0058 Reference 21B4 (Data)", ROMX[$6BCD], BANK[$6B]
GameSceneNPCScriptReference21B4::
  db "じゃあ<BR>ていげきに　もどりましょう。",$00

SECTION "Game Scene NPC Script 0058 Reference 21B5 (Subroutine)", ROMX[$50AA], BANK[$56]
GameSceneNPCScriptReference21B5::
  ...
  db $07 ; Portrait
    db $21
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21D9, BANK(GameSceneNPCScriptReference21D9)
  db $07 ; Portrait
    db $88
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21DA, BANK(GameSceneNPCScriptReference21DA)
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21DB, BANK(GameSceneNPCScriptReference21DB)
  db $07 ; Portrait
    db $23
  db $00 ; WriteText
    dwb GameSceneNPCScriptReference21DC, BANK(GameSceneNPCScriptReference21DC)
  db $07 ; Portrait
    db $00
  db $00 ; WriteText
  ...
  db $01 ; TimedOption
    ...
    db $56
    dwb GameSceneNPCScriptReference21DE, BANK(GameSceneNPCScriptReference21DE) ; Text
    dw GameSceneNPCScriptReference21DF ; Option Branch
    dwb GameSceneNPCScriptReference21E0, BANK(GameSceneNPCScriptReference21E0) ; Text
    dw GameSceneNPCScriptReference21E1 ; Option Branch
    dw $FFFF

SECTION "Game Scene NPC Script 0058 Reference 21B6 (Subroutine)", ROMX[$4739], BANK[$56]
GameSceneNPCScriptReference21B6::
  ...
  db $01 ; TimedOption
    db $01 ; Available Time
    db $0C
    dwb GameSceneNPCScriptReference21F0, BANK(GameSceneNPCScriptReference21F0) ; Text
    dw GameSceneNPCScriptReference21F1 ; Option Branch
    dwb GameSceneNPCScriptReference21F2, BANK(GameSceneNPCScriptReference21F2) ; Text
    dw GameSceneNPCScriptReference21F3 ; Option Branch
    dw $FFFF

SECTION "Game Scene NPC Script 0058 Reference 21B7 (Subroutine)", ROMX[$62EC], BANK[$56]
...
SECTION "Game Scene NPC Script 0058 Reference 21B8 (Subroutine)", ROMX[$5A08], BANK[$56]
...
SECTION "Game Scene NPC Script 0058 Reference 21BF (Data)", ROMX[$5037], BANK[$6B]
GameSceneNPCScriptReference21BF::
  db "こどもと　はなしても<BR>じかんの　ムダ……",$00

SECTION "Game Scene NPC Script 0058 Reference 21C0 (Data)", ROMX[$504C], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21C3 (Data)", ROMX[$50AF], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21CA (Data)", ROMX[$5182], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21CD (Data)", ROMX[$51E1], BANK[$6B]
GameSceneNPCScriptReference21CD::
  db "やりましたね　おおがみさん。",$00

SECTION "Game Scene NPC Script 0058 Reference 21CE (Data)", ROMX[$51F0], BANK[$6B]
GameSceneNPCScriptReference21CE::
  db "うん　<NAME>くんも<BR>よくやったぞ。",$00

SECTION "Game Scene NPC Script 0058 Reference 21CF (Data)", ROMX[$5200], BANK[$6B]
...
SECTION "Game Scene NPC Script 0058 Reference 21D6 (Data)", ROMX[$7C5C], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 21DB (Data)", ROMX[$7CEE], BANK[$69]
GameSceneNPCScriptReference21DB::
  db "それぐらいのこと<BR>みたら　わかるじゃ<BR>ないですか。　おバカちゃん。",$00

SECTION "Game Scene NPC Script 0058 Reference 21DC (Data)", ROMX[$7D10], BANK[$69]
GameSceneNPCScriptReference21DC::
  db "アイリス　バカじゃない……<BR>バカじゃないもん〜……",$00

SECTION "Game Scene NPC Script 0058 Reference 21DD (Data)", ROMX[$7D2A], BANK[$69]
GameSceneNPCScriptReference21DD::
  db "ア　アイリスが<BR>ないちゃった……<BR>どうしよう……",$00

SECTION "Game Scene NPC Script 0058 Reference 21DE (Data)", ROMX[$7D43], BANK[$69]
GameSceneNPCScriptReference21DE::
  db "アイリスを　はげます",$00

SECTION "Game Scene NPC Script 0058 Reference 21DF (Subroutine)", ROMX[$5110], BANK[$56]
GameSceneNPCScriptReference21DF::
  ...
  db $08 ; Local Branch
    dw GameSceneNPCScriptReference2223
    db $00
...
SECTION "Game Scene NPC Script 0058 Reference 21E0 (Data)", ROMX[$7D4E], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 21E8 (Data)", ROMX[$6296], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 21ED (Data)", ROMX[$6328], BANK[$69]
GameSceneNPCScriptReference21ED::
  db "それぐらいのこと<BR>みたら　わかるじゃ<BR>ないですか。　おバカちゃん。",$00

SECTION "Game Scene NPC Script 0058 Reference 21EE (Data)", ROMX[$634A], BANK[$69]
GameSceneNPCScriptReference21EE::
  db "アイリス　バカじゃない……<BR>バカじゃないもん〜……",$00

SECTION "Game Scene NPC Script 0058 Reference 21EF (Data)", ROMX[$6364], BANK[$69]
GameSceneNPCScriptReference21EF::
  db "ア　アイリスが<BR>ないちゃった……<BR>どうしようかしら……",$00

SECTION "Game Scene NPC Script 0058 Reference 21F0 (Data)", ROMX[$6380], BANK[$69]
GameSceneNPCScriptReference21F0::
  db "アイリスを　はげます",$00

SECTION "Game Scene NPC Script 0058 Reference 21F1 (Subroutine)", ROMX[$479F], BANK[$56]
GameSceneNPCScriptReference21F1::
  ...
  db $08 ; Local Branch
    dw GameSceneNPCScriptReference2237
    db $00
...
SECTION "Game Scene NPC Script 0058 Reference 21F2 (Data)", ROMX[$638B], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 21F9 (Data)", ROMX[$6DFD], BANK[$6A]
GameSceneNPCScriptReference21F9::
  db "あらららららら。<BR>おサルさんみたいに<BR>まっかになっちゃって。",$00

SECTION "Game Scene NPC Script 0058 Reference 21FA (Data)", ROMX[$6E1C], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 21FD (Data)", ROMX[$6E89], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 2204 (Data)", ROMX[$6F6A], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 2207 (Data)", ROMX[$6FC9], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 220F (Data)", ROMX[$55BA], BANK[$6A]
GameSceneNPCScriptReference220F::
  db "あらららららら。<BR>おサルさんみたいに<BR>まっかになっちゃって。",$00

SECTION "Game Scene NPC Script 0058 Reference 2210 (Data)", ROMX[$55D9], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 2213 (Data)", ROMX[$5646], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 221A (Data)", ROMX[$5727], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 221D (Data)", ROMX[$5786], BANK[$6A]
...
SECTION "Game Scene NPC Script 0058 Reference 2228 (Data)", ROMX[$7E11], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 222E (Data)", ROMX[$7ED4], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 223D (Data)", ROMX[$645B], BANK[$69]
...
SECTION "Game Scene NPC Script 0058 Reference 2243 (Data)", ROMX[$651E], BANK[$69]
