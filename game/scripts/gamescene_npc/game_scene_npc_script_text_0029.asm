...
SECTION "Text0029 Bank 63 Segment 0", ROMX[$4961], BANK[$63]
...
SECTION "Text0029 Bank 63 Segment 1", ROMX[$4D85], BANK[$63]
...
SECTION "Text0029 Bank 63 Segment 2", ROMX[$5217], BANK[$63]
GameSceneNPCScriptReference101F::
	  db "これが『まじんき』ね……<BR>はやく　ボイラーをうごかして<BR>だんぼうで　こおりを<BR>とかさなきゃ。",$00

SECTION "Text0029 Bank 63 Segment 3", ROMX[$6873], BANK[$63]
...
SECTION "Text0029 Bank 63 Segment 4", ROMX[$6BE0], BANK[$63]
...
SECTION "Text0029 Bank 63 Segment 5", ROMX[$70AD], BANK[$63]
...
SECTION "Text0029 Bank 64 Segment 0", ROMX[$47F3], BANK[$64]
...
SECTION "Text0029 Bank 64 Segment 1", ROMX[$4C99], BANK[$64]
...
SECTION "Text0029 Bank 64 Segment 2", ROMX[$51AB], BANK[$64]
GameSceneNPCScriptReference10BF::
	  db "これが『まじんき』ね……<BR>はやく　ボイラーをうごかして<BR>だんぼうで　こおりを<BR>とかさなきゃ。",$00

SECTION "Text0029 Bank 64 Segment 3", ROMX[$6833], BANK[$64]
...
SECTION "Text0029 Bank 64 Segment 4", ROMX[$6BD6], BANK[$64]
...
SECTION "Text0029 Bank 64 Segment 5", ROMX[$70F2], BANK[$64]
...
SECTION "Text0029 Bank 65 Segment 0", ROMX[$4AEC], BANK[$65]
...
SECTION "Text0029 Bank 65 Segment 1", ROMX[$4E0C], BANK[$65]
...
SECTION "Text0029 Bank 65 Segment 2", ROMX[$525E], BANK[$65]
...
SECTION "Text0029 Bank 65 Segment 3", ROMX[$68D5], BANK[$65]
...
SECTION "Text0029 Bank 65 Segment 4", ROMX[$6DC1], BANK[$65]
...
SECTION "Text0029 Bank 65 Segment 5", ROMX[$72CD], BANK[$65]
