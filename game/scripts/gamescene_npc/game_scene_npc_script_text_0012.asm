...
SECTION "Text0012 Bank 60 Segment 0", ROMX[$7412], BANK[$60]
GameSceneNPCScriptReference04D9::
	  db "<NAME>!<BR>あのスイッチだよ。",$00
GameSceneNPCScriptReference04DA::
	  db "りょうかい!",$00

SECTION "Text0012 Bank 60 Segment 1", ROMX[$7495], BANK[$60]
...
SECTION "Text0012 Bank 61 Segment 0", ROMX[$4EA7], BANK[$61]
GameSceneNPCScriptReference04E2::
	  db "<NAME>!<BR>あのスイッチだよ。",$00
GameSceneNPCScriptReference04E3::
	  db "りょうかい!!",$00

SECTION "Text0012 Bank 61 Segment 1", ROMX[$4F2B], BANK[$61]
...
SECTION "Text0012 Bank 61 Segment 2", ROMX[$68B0], BANK[$61]
GameSceneNPCScriptReference04F4::
	  db "<NAME>さん<BR>あのスイッチを　おすんです!",$00
GameSceneNPCScriptReference04F5::
	  db "りょうかい!!",$00

SECTION "Text0012 Bank 61 Segment 3", ROMX[$6937], BANK[$61]
...
SECTION "Text0012 Bank 62 Segment 0", ROMX[$41C6], BANK[$62]
GameSceneNPCScriptReference04FD::
	  db "<NAME>さん<BR>あのスイッチを　おすんです!",$00
GameSceneNPCScriptReference04FE::
	  db "りょうかい!!",$00

SECTION "Text0012 Bank 62 Segment 1", ROMX[$424D], BANK[$62]
...
SECTION "Text0012 Bank 62 Segment 2", ROMX[$5F59], BANK[$62]
GameSceneNPCScriptReference04EB::
	  db "<NAME>　あれだ。<BR>あのスイッチを　おすんだ。",$00
GameSceneNPCScriptReference04EC::
	  db "りょうかい!!",$00

SECTION "Text0012 Bank 62 Segment 3", ROMX[$5FDA], BANK[$62]
...
SECTION "Text0012 Bank 62 Segment 4", ROMX[$7637], BANK[$62]
GameSceneNPCScriptReference0506::
	  db "<NAME>さん<BR>あのスイッチを<BR>おすのですわよ。",$00
GameSceneNPCScriptReference0507::
	  db "りょうかい!!",$00

SECTION "Text0012 Bank 62 Segment 5", ROMX[$76C5], BANK[$62]
