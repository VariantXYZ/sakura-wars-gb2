...
SECTION "Text0024 Bank 63 Segment 0", ROMX[$629B], BANK[$63]
...
SECTION "Text0024 Bank 63 Segment 1", ROMX[$64A1], BANK[$63]
GameSceneNPCScriptReference095C::
  db "スクラップだらけです。",$00

SECTION "Text0024 Bank 64 Segment 0", ROMX[$4201], BANK[$64]
...
SECTION "Text0024 Bank 64 Segment 1", ROMX[$440D], BANK[$64]
GameSceneNPCScriptReference0979::
  db "スクラップだらけです。",$00

SECTION "Text0024 Bank 64 Segment 2", ROMX[$6210], BANK[$64]
...
SECTION "Text0024 Bank 64 Segment 3", ROMX[$6450], BANK[$64]
GameSceneNPCScriptReference0996::
  db "スクラップだらけです。",$00

SECTION "Text0024 Bank 65 Segment 0", ROMX[$427E], BANK[$65]
...
SECTION "Text0024 Bank 65 Segment 1", ROMX[$44BD], BANK[$65]
GameSceneNPCScriptReference09B3::
  db "スクラップだらけです。",$00

SECTION "Text0024 Bank 65 Segment 2", ROMX[$6317], BANK[$65]
...
SECTION "Text0024 Bank 65 Segment 3", ROMX[$6520], BANK[$65]
GameSceneNPCScriptReference09D0::
  db "スクラップだらけです。",$00

SECTION "Text0024 Bank 66 Segment 0", ROMX[$43BB], BANK[$66]
...
SECTION "Text0024 Bank 66 Segment 1", ROMX[$465F], BANK[$66]
