...
SECTION "Text0061 Bank 6B Segment 0", ROMX[$71C1], BANK[$6B]
...
SECTION "Text0061 Bank 6B Segment 1", ROMX[$7240], BANK[$6B]
...
SECTION "Text0061 Bank 6B Segment 2", ROMX[$7335], BANK[$6B]
