...
SECTION "Text005A Bank 6B Segment 0", ROMX[$73A6], BANK[$6B]
...
SECTION "Text005A Bank 6B Segment 1", ROMX[$7409], BANK[$6B]
...
SECTION "Text005A Bank 6B Segment 2", ROMX[$763A], BANK[$6B]
