...
SECTION "Text0074 Bank 6E Segment 0", ROMX[$5A03], BANK[$6E]
...
SECTION "Text0074 Bank 6E Segment 1", ROMX[$5AB4], BANK[$6E]
GameSceneNPCScriptReference2A13::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A14::
  db "がんばりましょう<BR><NAME>さん。",$00

SECTION "Text0074 Bank 6E Segment 2", ROMX[$66BD], BANK[$6E]
...
SECTION "Text0074 Bank 6E Segment 3", ROMX[$67A1], BANK[$6E]
GameSceneNPCScriptReference2A1A::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A1B::
  db "がんばりましょう<BR><NAME>さん。",$00

SECTION "Text0074 Bank 6E Segment 4", ROMX[$73C2], BANK[$6E]
...
SECTION "Text0074 Bank 6E Segment 5", ROMX[$7487], BANK[$6E]
GameSceneNPCScriptReference2A21::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A22::
  db "いいへんじですわ。<BR><NAME>さん。<BR>では　まいりますわよ!!",$00

SECTION "Text0074 Bank 6F Segment 0", ROMX[$411F], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 1", ROMX[$41D2], BANK[$6F]
GameSceneNPCScriptReference2A28::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A29::
  db "いいへんじですわ。<BR><NAME>さん。<BR>では　まいりますわよ!!",$00

SECTION "Text0074 Bank 6F Segment 2", ROMX[$4E99], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 3", ROMX[$4F44], BANK[$6F]
GameSceneNPCScriptReference2A2F::
  db "うん!　がんばろう!!",$00
GameSceneNPCScriptReference2A30::
  db "エヘヘ……<BR>アイリスを　まもってね<BR><NAME>。",$00

SECTION "Text0074 Bank 6F Segment 4", ROMX[$5AE5], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 5", ROMX[$5B93], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 6", ROMX[$676C], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 7", ROMX[$6823], BANK[$6F]
GameSceneNPCScriptReference2A3D::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A3E::
  db "きあい　じゅうぶんだな<BR><NAME>!!<BR>じゃ　いくぜ!!!",$00

SECTION "Text0074 Bank 6F Segment 8", ROMX[$73E9], BANK[$6F]
...
SECTION "Text0074 Bank 6F Segment 9", ROMX[$749B], BANK[$6F]
GameSceneNPCScriptReference2A44::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A45::
  db "きあい　じゅうぶんだな<BR><NAME>!!<BR>じゃ　いくぜ!!!",$00

SECTION "Text0074 Bank 90 Segment 0", ROMX[$406D], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 1", ROMX[$410A], BANK[$90]
GameSceneNPCScriptReference2A4B::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A4C::
  db "いいへんじね。<BR>では　いくわよ<BR><NAME>くん!!",$00

SECTION "Text0074 Bank 90 Segment 2", ROMX[$4CAA], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 3", ROMX[$4D42], BANK[$90]
GameSceneNPCScriptReference2A52::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A53::
  db "いいへんじね。<BR>では　いくわよ　<NAME>!",$00

SECTION "Text0074 Bank 90 Segment 4", ROMX[$58BE], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 5", ROMX[$5959], BANK[$90]
GameSceneNPCScriptReference29D9::
  db "りょうかい!",$00
GameSceneNPCScriptReference29DA::
  db "よし。<BR>じゃあ　いこう。<BR><NAME>!!",$00

SECTION "Text0074 Bank 90 Segment 6", ROMX[$6466], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 7", ROMX[$6500], BANK[$90]
GameSceneNPCScriptReference29E0::
  db "りょうかい!",$00
GameSceneNPCScriptReference29E1::
  db "よし。<BR>じゃあ　いこう。<BR><NAME>!!",$00

SECTION "Text0074 Bank 90 Segment 8", ROMX[$7013], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 9", ROMX[$7099], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 10", ROMX[$7C34], BANK[$90]
...
SECTION "Text0074 Bank 90 Segment 11", ROMX[$7CE3], BANK[$90]
...
SECTION "Text0074 Bank 91 Segment 0", ROMX[$48B4], BANK[$91]
...
SECTION "Text0074 Bank 91 Segment 3", ROMX[$55E8], BANK[$91]
GameSceneNPCScriptReference29FE::
  db "りょうかい!",$00
GameSceneNPCScriptReference29FF::
  db "ほな　ビシッと　きあいを<BR>いれて　いきましょか<BR><NAME>はん!!",$00

SECTION "Text0074 Bank 91 Segment 4", ROMX[$619B], BANK[$91]
...
SECTION "Text0074 Bank 91 Segment 5", ROMX[$6242], BANK[$91]
GameSceneNPCScriptReference2A05::
  db "りょうかい!",$00
GameSceneNPCScriptReference2A06::
  db "いいへんじでーす。<BR>では　<NAME>さん<BR>レッツ　ゴー!!",$00

SECTION "Text0074 Bank 91 Segment 6", ROMX[$6EAE], BANK[$91]
...
SECTION "Text0074 Bank 91 Segment 7", ROMX[$6F70], BANK[$91]
