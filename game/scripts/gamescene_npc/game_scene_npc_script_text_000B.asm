...
SECTION "Text000B Bank 60 Segment 0", ROMX[$69A5], BANK[$60]
...
SECTION "Text000B Bank 60 Segment 1", ROMX[$6C22], BANK[$60]
GameSceneNPCScriptReference029B::
	  db "エンジンをうごかせば<BR>つかえるね。",$00

SECTION "Text000B Bank 61 Segment 0", ROMX[$4419], BANK[$61]
...
SECTION "Text000B Bank 61 Segment 1", ROMX[$46D7], BANK[$61]
GameSceneNPCScriptReference02B2::
	  db "エンジンをうごかせば<BR>つかえるね。",$00

SECTION "Text000B Bank 61 Segment 2", ROMX[$5CF1], BANK[$61]
...
SECTION "Text000B Bank 61 Segment 3", ROMX[$5DD1], BANK[$61]
...
SECTION "Text000B Bank 61 Segment 4", ROMX[$6189], BANK[$61]
GameSceneNPCScriptReference02ED::
	  db "エンジンをうごかせば<BR>つかえそうですね。",$00

SECTION "Text000B Bank 61 Segment 5", ROMX[$7824], BANK[$61]
...
SECTION "Text000B Bank 61 Segment 6", ROMX[$7A8F], BANK[$61]
GameSceneNPCScriptReference0305::
	  db "エンジンをうごかせば<BR>つかえそうですね。",$00

SECTION "Text000B Bank 62 Segment 0", ROMX[$5823], BANK[$62]
...
SECTION "Text000B Bank 62 Segment 1", ROMX[$59FF], BANK[$62]
GameSceneNPCScriptReference02C5::
	  db "エンジンをうごかせば<BR>つかえそうだな。",$00

SECTION "Text000B Bank 62 Segment 2", ROMX[$6D7A], BANK[$62]
...
SECTION "Text000B Bank 62 Segment 3", ROMX[$6FE4], BANK[$62]
