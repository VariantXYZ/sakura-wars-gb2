...
SECTION "Text005C Bank 6B Segment 0", ROMX[$77F4], BANK[$6B]
...
SECTION "Text005C Bank 6B Segment 1", ROMX[$7884], BANK[$6B]
...
SECTION "Text005C Bank 6B Segment 2", ROMX[$79B7], BANK[$6B]
