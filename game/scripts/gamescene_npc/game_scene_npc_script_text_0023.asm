...
SECTION "Text0023 Bank 63 Segment 0", ROMX[$6064], BANK[$63]
...
SECTION "Text0023 Bank 63 Segment 1", ROMX[$628F], BANK[$63]
GameSceneNPCScriptReference08A7::
	  db "スクラップだらけです。",$00

SECTION "Text0023 Bank 63 Segment 2", ROMX[$7FE9], BANK[$63]
GameSceneNPCScriptReference08AC::
	  db "おや?　これはなんだ?",$00

SECTION "Text0023 Bank 64 Segment 0", ROMX[$4000], BANK[$64]
...
SECTION "Text0023 Bank 64 Segment 1", ROMX[$41F5], BANK[$64]
GameSceneNPCScriptReference08C5::
	  db "スクラップだらけです。",$00

SECTION "Text0023 Bank 64 Segment 2", ROMX[$6012], BANK[$64]
...
SECTION "Text0023 Bank 64 Segment 3", ROMX[$6204], BANK[$64]
GameSceneNPCScriptReference08E0::
	  db "スクラップだらけです。",$00

SECTION "Text0023 Bank 65 Segment 0", ROMX[$4087], BANK[$65]
...
SECTION "Text0023 Bank 65 Segment 1", ROMX[$4272], BANK[$65]
GameSceneNPCScriptReference08FB::
	  db "スクラップだらけです。",$00

SECTION "Text0023 Bank 65 Segment 2", ROMX[$6144], BANK[$65]
...
SECTION "Text0023 Bank 65 Segment 3", ROMX[$630B], BANK[$65]
GameSceneNPCScriptReference0916::
	  db "スクラップだらけです。",$00

SECTION "Text0023 Bank 66 Segment 0", ROMX[$415C], BANK[$66]
...
SECTION "Text0023 Bank 66 Segment 1", ROMX[$43AF], BANK[$66]
