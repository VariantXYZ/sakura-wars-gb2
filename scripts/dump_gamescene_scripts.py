...
with open(rom_path, 'rb') as rom:
    ...
    with open(os.path.join(game_scene_script_dir, f'game_scene_scripts.asm'), 'w') as script_fp:
        script_fp.write(f"; File initially autogenerated by {script_name}\n")
        script_fp.write('\n')
        script_fp.write(f'INCLUDE "{os.path.join(game_scene_script_dir, f"commands.asm")}"\n')
        script_fp.write('\n')
